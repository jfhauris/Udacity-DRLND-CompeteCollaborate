...
class DDPGAgent():
    ...
    def learn(self, index, experiences, gamma, all_next_actions, all_actions):
        ...
        #print('all_next_actions "', all_next_actions)
        #input()
        ...
        #print('========================\n')
        #print('len all next actions, actions next :\n', len(all_next_actions), len(actions_next))
        #print('============================\n')
        #print(all_next_actions[0].shape)
        #print(actions_next[0].shape)
        #input()
        with torch.no_grad():
